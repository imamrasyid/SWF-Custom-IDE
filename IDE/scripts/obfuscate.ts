...
const OBFUSCATOR_OPTIONS = {
  ...
  stringArrayEncoding: [], // Disable encoding to prevent breaking Node module loading / require()
  ...
  transformObjectKeys: false, // Disable to prevent breaking property access on third-party libraries
